...
paths = {'bbbp': '/content/MESPool/datasets/BBBP.csv',
         'bace': '/content/MESPool/datasets/bace.csv',
         'clintox': '/content/MESPool/datasets/clintox.csv',
         'hiv': '/content/MESPool/datasets/HIV.csv',
         'tox21': '/content/MESPool/datasets/tox21.csv',
         'esol': '/content/MESPool/datasets/esol.csv',
         'freesolv': '/content/MESPool/datasets/freesolv.csv',
         'lipo': '/content/MESPool/datasets/Lipophilicity.csv',
         'muv': '/content/MESPool/datasets/muv.csv',
         'sider': '/content/MESPool/datasets/sider.csv',
         'qm7': '/content/MESPool/datasets/qm7.csv',
         'qm8': '/content/MESPool/datasets/qm8.csv',
         'qm9': '/content/MESPool/datasets/qm9.csv',
         'covid': '/content/MESPool/datasets/covid.csv',
         'muta': '/content/MESPool/datasets/Mutagenicity.csv'}
