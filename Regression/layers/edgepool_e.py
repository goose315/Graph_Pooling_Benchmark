...
class EdgePooling_E(torch.nn.Module):
    ...
    def __init__(self, in_channels_x, in_channels_e, edge_score_method=None, dropout=0,
                 add_to_edge_score=0.5):
        super().__init__()
        self.in_channels = in_channels_x
        ...
        self.lin = torch.nn.Linear(2 * in_channels_x + in_channels_e, 1)
    ...
    def __merge_edges__(self, x, edge_index, edge_attr, batch, edge_score):
        ...
        new_edge_index, new_edge_attr = coalesce(cluster[edge_index], edge_attr, N)
